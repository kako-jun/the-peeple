/**
 * the-peeple ゲーム共通型定義 (Issues #11-#18)。
 */
...
/**
 * ゲームモード。
 * - STAND_OFF   : 男子便所版 (デフォルト)。
 * - LINE_RUSH   : 女子トイレ行列版 (#19 stub)。
 */
export type GameMode = 'STAND_OFF' | 'LINE_RUSH'

/**
 * 難易度。
 * - NORMAL : スポーン間隔 3000ms、RUSHER/DRUNK 低確率。
 * - HARD   : スポーン間隔 1800ms、RUSHER/DRUNK 高確率。
 */
...
export interface Char {
  ...
  /** 用を足す合計時間 (ms)。spawnChar 時に useDuration と同じ値で初期化。残り時間バー計算用。 */
